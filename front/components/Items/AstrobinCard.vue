    ...
    >
      ...
      >
        ...
        >
          ...
          <v-expand-transition>
            <div
              class="d-flex transition-fast-in-fast-out text-white v-card--reveal display-3 white--text"
              style="height: 100%;"
            >
          ...
          <template #append>
            <div class="justify-self-end">
              <v-icon
                icon="mdi-eye"
                color="grey"
              /> <span class="subheading me-2">{{ item.views }}</span>
              <v-icon
                icon="mdi-heart"
                color="grey"
              /> <span class="subheading me-2">{{ item.likes }}</span>
            </div>
          </template>
        </v-list-item>
      </v-card-actions>
